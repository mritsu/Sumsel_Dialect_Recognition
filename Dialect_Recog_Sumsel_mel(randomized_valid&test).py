...
# array untuk train data
me=[]
lab=[]

# array untuk valid & test data
me1=[]
lab1=[]
...
mee = pd.DataFrame(me)
mee.to_csv('C:/Users/MRizkiP/Documents/Source Code/PYTHON/Dataset/Dataset Logat/train/me_train.csv', index=False)
la = pd.DataFrame(lab)
la.to_csv('C:/Users/MRizkiP/Documents/Source Code/PYTHON/Dataset/Dataset Logat/train/labels_train.csv', index=False)
la = pd.get_dummies(lab) #Encode the label

mee1 = pd.DataFrame(me1)
mee1.to_csv('C:/Users/MRizkiP/Documents/Source Code/PYTHON/Dataset/Dataset Logat/valid&test/me_valid&test_random.csv', index=False)
la1 = pd.DataFrame(lab1)
la1.to_csv('C:/Users/MRizkiP/Documents/Source Code/PYTHON/Dataset/Dataset Logat/valid&test/labels_valid&test_random.csv', index=False)
...
tran = StandardScaler()
features_train = tran.fit_transform(mee)
features_train1 = tran.fit_transform(mee1)
...
# Set title
plt.title('Training and Validation Accuracy (n_mel=256)', fontsize = 21)
...
plt.title('Training Loss (n_mel=256)', fontsize = 21)
plt.xlabel('Epoch', fontsize = 18)
plt.legend(fontsize = 18)
...
plt.title('Validation Loss (n_mel=256)', fontsize = 21)
plt.xlabel('Epoch', fontsize = 18)
plt.legend(fontsize = 18)
plt.ylabel('Loss', fontsize = 18)
plt.show()
...
conf_mat=multilabel_confusion_matrix(test_label, prediction, labels=label_columns1.to_numpy())
print(conf_mat)
